...
<div class="container col-md-8">
    <div class="p-5">
        <div class="text-center">
            <h3 class="h4 text-gray-900 mb-4">Alta Pacientes</h3>
            <p class="mb-4">Este es el apartado para dar de alta a los diferentes pacientes del sistema</p>
        </div>
        <div>
            <form action="/pacientes" method="POST" class="user">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user mb-3" id="obra_social"
                           name="obra_social" placeholder="Obra Social" checked="">
                </div>
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user mb-3" id="tipo_sangre"
                           name="tipo_sangre" placeholder="Tipo Sangre" checked="">
                </div>
            </div>
